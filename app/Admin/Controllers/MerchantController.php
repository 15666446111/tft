...
class MerchantController extends AdminController
{
    ...
    protected function grid()
    {
        ...
        if(Admin::user()->operate != "All"){
            $grid->model()->where('verfity_state', 1)->where('operate', Admin::user()->operate);
        }
        ...
        $grid->column('owner_name', __('法人姓名'))->help('商户的法人名称');

        $grid->column('mch_type', __('商户类型'))->using([
            0   =>  '企业商户', 1   =>  '个体商户', 2   =>  '小微商户'
        ])->help('商户的类型');
        ...
        $grid->column('addr', __('经营地址'))->help('商户的经营地址');
        ...
        **/
        ...
        $grid->column('verfity_state', __('审核状态'))->bool()->help('审核状态');
