...
Route::prefix('V1')->group(function () {
    ...
    Route::middleware('AuthToken')->get('/mcc',             'V1\MccController@index');           // 商户注册 - 获取MCC
    Route::middleware('AuthToken')->get('/province',        'V1\MccController@province');        // 商户注册 - 获取省份
    Route::middleware('AuthToken')->get('/city',            'V1\MccController@city');            // 商户注册 - 获取城市
    Route::middleware('AuthToken')->get('/area',            'V1\MccController@area');            // 商户注册 - 获取区域
